...
public class Dispatcher2 {
    ...
    private static Dispatcher2 sInstance;
    private final RxBus mRxBus;
    private ArrayMap<String, Disposable> mRxActionMap;
    private ArrayMap<String, Disposable> mRxStoreMap;

    private Dispatcher2(RxBus rxBus) {
        this.mRxBus = rxBus;
        this.mRxActionMap = new ArrayMap<>();
        this.mRxStoreMap = new ArrayMap<>();
    }

    public static synchronized Dispatcher2 getInstance(RxBus rxBus) {
        if (sInstance == null) sInstance = new Dispatcher2(rxBus);
        return sInstance;
    }
