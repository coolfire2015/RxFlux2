...
public class FileUtils {
    ...
    public static String getMsgFilePath(Context context) {
        return null;
        // return getCacheFilePath(context) + LocalStorageUtils.getInstance().getInt(ActionsKeys.USER_ID,
        // ActionsKeys.DEFAULT_INT) + "/file/";
    }
    ...
    public static String getCacheFilePath(Context context) {
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) { // SD卡可用
            path = Environment.getExternalStorageDirectory() + File.separator + context.getPackageName()
